...
namespace Calculadora.Web.Controllers
{
    ...
    {
        IndicesCorrecaoBusiness indiceBusiness;
        ValoresIndiceCorrecaoBusiness valorBusiness;

        public IndicesCorrecaoController(VanguardaContext context)
        {
            indiceBusiness = new IndicesCorrecaoBusiness(context);
            valorBusiness = new ValoresIndiceCorrecaoBusiness(context);
        }

        // GET: IndicesCorrecao
        public IActionResult IndexIC(string sortOrder, bool percentagemFilter, bool valorFilter, bool aniversarioFilter, bool somatorioFilter, bool mensaisFilter, bool diariosFilter, bool atualizadosFilter, bool desatualizadosFilter, bool extintosFilter, string searchString, int? page)
        {
        ...
        public ActionResult CreateIC([Bind("IndiceCorrecaoID,Nome,Periodicidade,Tipo,DataInicio,DataFim,UltimoValor,Descricao,Estado,Informacoes,Extinto,Atualizado")] IndiceCorrecao indiceCorrecao)
        {
        ...
        [HttpPost]
        public ActionResult ConsultaValoresICAjax(int indiceCorrecaoID, Calculadora.web.Models.DataTable.DataTableRequest dataTableRequest)
        {
            return Json(new Calculadora.web.Models.DataTable.DataTableResponse()
            {
