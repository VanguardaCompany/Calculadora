...
namespace Calculadora.Web.Controllers
{
    public class ValoresIndiceCorrecaoController : Controller
    {
        ...
        public ActionResult Create([Bind("Data,IndiceCorrecaoID,Valor")] ValorIndiceCorrecao valorIndiceCorrecao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind("Data,IndiceCorrecaoID,Valor")] ValorIndiceCorrecao valorIndiceCorrecao)
        {
            //if (ModelState.IsValid)
            //{
